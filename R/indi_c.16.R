...
#' @examples
#' c.16 <- indi_c.16(conn = conn, ano = 2010, agr = "mun")

indi_c.16 <- function(conn, ano, agr, multi = 1000){

  sim <- get_sim(conn = conn, ano = ano, agr = agr, idade_obito_anos_min = 0, idade_obito_anos_max = 5)
